...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="transactionRecordList" :cell-style="mainCellStyle">
      ...
      <el-table-column label="买币" align="center" prop="transactionBuyAmount" />
      <el-table-column label="卖币" align="center" prop="transactionSaleAmount" />
...
<script>
import {getUserTotalAmount, listUserTransactionMoney} from "@/api/system/transactionRecord";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.getTotalAmount();
      listUserTransactionMoney(this.queryParams).then(response => {
    ...
    getMerchantTransactionList() {
      ...
      listUserTransactionMoney(this.dialogMerchantTransactionQueryParams).then(response => {
    ...
    getMerchantTotalAmount(){
      getUserTotalAmount(this.dialogMerchantTransactionQueryParams).then(response => {
    ...
    getProxyTransactionList() {
      ...
      listUserTransactionMoney(this.dialogProxyTransactionQueryParams).then(response => {
    ...
    getProxyTotalAmount(){
      getUserTotalAmount(this.dialogProxyTransactionQueryParams).then(response => {
